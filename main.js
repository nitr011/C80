...
var length_of_the_student_array = length_of_the_student_array.length;
console.log(length_of_the_student_array);

for(var k = 0; k < length_of_the_student_array; k++)
{
    display_student_array.push("<h4> NAME- "+ length_of_the_student_array[k] +"</h4>");
...
function sorting()
{
    ...
    console.log(length_of_the_student_array);
    for(k=0; k < length_of_the_student_array; k++)
    {
